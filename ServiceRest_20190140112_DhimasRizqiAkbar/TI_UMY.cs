...
namespace ServiceRest_20190140112_DhimasRizqiAkbar
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data source=LAPTOP-DMHSR8SA; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=dhimas123"); // Authentication=Windows Authentication
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data source=LAPTOP-DMHSR8SA; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=dhimas123"); // Authentication=Windows Authentication
